@component('layouts.components.landingHeader')  
@endcomponent
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5 offset-md-1 margin-top-20">
                    ...
                    <div class="register-form-home-wrapper wow bounceIn" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: bounceIn;">
                        ...
                        <div>
                            ...
                            <p class="register_success_box_home" style="display:none;">We received your message and you will hear from us soon. Thank You!</p>
                            <!--end success message -->
...
<!-- 
                            ...
                            <p class="register-form-terms-home">No Credit Card &#8226; No Installation Required</p>
                    ...
                    <div class="nav flex-column nav-pills margin-right-25" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">
                            ...
                            <div class="features-second">
                                ...
                                <img src="/getleads/images/services-icon1.png" alt="pic">
                        ...
                        <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">
                            ...
                            <div class="features-second">
                                ...
                                <img src="/getleads/images/services-icon2.png" alt="pic">
                        ...
                        <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">
                            ...
                            <div class="features-second">
                                ...
                                <img src="/getleads/images/services-icon3.png" alt="pic">
                ...
                <div class="col-md-6 padding-bottom-30">
                    ...
                    <div class="tab-content margin-left-20" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                            <img src="http://placehold.it/555x425" class="width-100 top-margins-images" alt="pic">
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4 text-center margin-top-30">
                    ...
                    <img src="http://placehold.it/400x400" class="team-img lyla width-100" alt="pic">
                   
                    <div class="team-item">
                    
                        <h3>CHRISTINA HAWKINS</h3>
                        
                        <div class="team-info lyla"><p>Head of SEO</p></div>
                ...
                <div class="col-sm-12 col-md-4 text-center margin-top-30">
                    ...
                    <img src="http://placehold.it/400x400" class="team-img blue width-100" alt="pic">
                   
                    <div class="team-item">
                    
                        <h3>ANDRES JOHANSON</h3>
                        
                        <div class="team-info blue"><p>Marketing Manager</p></div>
                ...
                <div class="col-sm-12 col-md-4 text-center margin-top-30">
                    ...
                    <img src="http://placehold.it/400x400" class="team-img yellow width-100" alt="pic">
    ...
    <!--begin fun-facts -->
    <section class="section-bg-1 small-padding">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-7 mx-auto padding-top-20 margin-bottom-10 text-center">
                    ...
                    <h3 class="white-text">Fun Facts About Our Agency</h3>
            ...
            <div class="newsletter_box">
              ...
              <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <img src="/getleads/images/email.png" alt="picture" class="padding-top-15">
                ...
                <div class="col-md-4">
                    ...
                    <div class="blog-item">
                        ...
                        <div class="blog-item-inner">
                            ...
                            <a href="#" class="blog-icons last"><i class="far fa-clock"></i> August 1st, 2021</a>
                ...
                <div class="col-md-4">
                    ...
                    <div class="blog-item">
                        ...
                        <div class="blog-item-inner">
                            ...
                            <a href="#" class="blog-icons last"><i class="far fa-clock"></i> September 27th, 2021</a>
                ...
                <div class="col-md-4">
                    ...
                    <div class="blog-item">
                        ...
                        <div class="blog-item-inner">
                            ...
                            <a href="#" class="blog-icons last"><i class="far fa-clock"></i> July 11th, 2021</a>
 ...
 @component('layouts.components.landingFooter')  
@endcomponent